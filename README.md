...
- 🌳 **Сад знаний**: каждая колода — дерево, чья листва отражает реальную кривую забывания;
  не повторяешь — дерево жухнет и роняет листья; тап — «полить» повторением этой колоды
